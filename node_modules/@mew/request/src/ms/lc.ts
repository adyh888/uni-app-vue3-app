...
export function Lc(service: any, isDebugMode: boolean = false) {
    return {
        log_clean: new Request<LogClean, LogCleanInsertProperty, LogCleanDeleteProperty, LogCleanUpdateProperty, LogCleanSelectProperty>('/lc/log_clean', service, isDebugMode),
        log_rent: new Request<LogRent, LogRentInsertProperty, LogRentDeleteProperty, LogRentUpdateProperty, LogRentSelectProperty>('/lc/log_rent', service, isDebugMode),
        log_modification_integral: new Request<LogModificationIntegral, LogModificationIntegralInsertProperty, LogModificationIntegralDeleteProperty, LogModificationIntegralUpdateProperty, LogModificationIntegralSelectProperty>('/lc/log_modification_integral', service, isDebugMode),
        email_template: new Request<EmailTemplate, EmailTemplateInsertProperty, EmailTemplateDeleteProperty, EmailTemplateUpdateProperty, EmailTemplateSelectProperty>('/lc/email_template', service, isDebugMode),
        log_measurement: new Request<LogMeasurement, LogMeasurementInsertProperty, LogMeasurementDeleteProperty, LogMeasurementUpdateProperty, LogMeasurementSelectProperty>('/lc/log_measurement', service, isDebugMode),
        log_scrap: new Request<LogScrap, LogScrapInsertProperty, LogScrapDeleteProperty, LogScrapUpdateProperty, LogScrapSelectProperty>('/lc/log_scrap', service, isDebugMode),
        log_test: new Request<LogTest, LogTestInsertProperty, LogTestDeleteProperty, LogTestUpdateProperty, LogTestSelectProperty>('/lc/log_test', service, isDebugMode),
        log_process: new Request<LogProcess, LogProcessInsertProperty, LogProcessDeleteProperty, LogProcessUpdateProperty, LogProcessSelectProperty>('/lc/log_process', service, isDebugMode),
        // class
        log: new Request<Log, LogInsertProperty, LogDeleteProperty, LogUpdateProperty, LogSelectProperty>('/lc/log', service, isDebugMode),
        log_feedback: new Request<LogFeedback, LogFeedbackInsertProperty, LogFeedbackDeleteProperty, LogFeedbackUpdateProperty, LogFeedbackSelectProperty>('/lc/log_feedback', service, isDebugMode),
        log_alarm: new Request<LogAlarm, LogAlarmInsertProperty, LogAlarmDeleteProperty, LogAlarmUpdateProperty, LogAlarmSelectProperty>('/lc/log_alarm', service, isDebugMode),
        log_user_login: new Request<LogUserLogin, LogUserLoginInsertProperty, LogUserLoginDeleteProperty, LogUserLoginUpdateProperty, LogUserLoginSelectProperty>('/lc/log_user_login', service, isDebugMode),
        log_shelf: new Request<LogShelf, LogShelfInsertProperty, LogShelfDeleteProperty, LogShelfUpdateProperty, LogShelfSelectProperty>('/lc/log_shelf', service, isDebugMode),
        log_charge: new Request<LogCharge, LogChargeInsertProperty, LogChargeDeleteProperty, LogChargeUpdateProperty, LogChargeSelectProperty>('/lc/log_charge', service, isDebugMode),
        log_apply: new Request<LogApply, LogApplyInsertProperty, LogApplyDeleteProperty, LogApplyUpdateProperty, LogApplySelectProperty>('/lc/log_apply', service, isDebugMode),
        log_lock: new Request<LogLock, LogLockInsertProperty, LogLockDeleteProperty, LogLockUpdateProperty, LogLockSelectProperty>('/lc/log_lock', service, isDebugMode),
        log_epc_goods: new Request<LogEpcGoods, LogEpcGoodsInsertProperty, LogEpcGoodsDeleteProperty, LogEpcGoodsUpdateProperty, LogEpcGoodsSelectProperty>('/lc/log_device_login', service, isDebugMode),
        log_device_login: new Request<LogDeviceLogin, LogDeviceLoginInsertProperty, LogDeviceLoginDeleteProperty, LogDeviceLoginUpdateProperty, LogDeviceLoginSelectProperty>('/lc/Request', service, isDebugMode),
        log_purchase: new Request<LogPurchase, LogPurchaseInsertProperty, LogPurchaseDeleteProperty, LogPurchaseUpdateProperty, LogPurchaseSelectProperty>('/lc/log_purchase', service, isDebugMode),
        log_purchase_details: new Request<LogPurchaseDetails, LogPurchaseDetailsInsertProperty, LogPurchaseDetailsDeleteProperty, LogPurchaseDetailsUpdateProperty, LogPurchaseDetailsSelectProperty>('/lc/log_purchase_details', service, isDebugMode),
        log_device_transfer: new Request<LogDeviceTransfer, LogDeviceTransferInsertProperty, LogDeviceTransferDeleteProperty, LogDeviceTransferUpdateProperty, LogDeviceTransferSelectProperty>('/lc/log_device_transfer', service, isDebugMode),
        log_overhaul: new Request<LogOverhaul, LogOverhaulInsertProperty, LogOverhaulDeleteProperty, LogOverhaulUpdateProperty, LogOverhaulSelectProperty>('/lc/log_overhaul', service, isDebugMode),
        log_periodical_examination: new Request<LogPeriodicalExamination, LogPeriodicalExaminationInsertProperty, LogPeriodicalExaminationDeleteProperty, LogPeriodicalExaminationUpdateProperty, LogPeriodicalExaminationSelectProperty>('/lc/log_periodical_examination', service, isDebugMode),
        log_patrol_inspection: new Request<LogPatrolInspection, LogPatrolInspectionInsertProperty, LogPatrolInspectionDeleteProperty, LogPatrolInspectionUpdateProperty, LogPatrolInspectionSelectProperty>('/lc/log_patrol_inspection', service, isDebugMode),
        log_pre_inspection: new Request<LogPreInspection, LogPreInspectionInsertProperty, LogPreInspectionDeleteProperty, LogPreInspectionUpdateProperty, LogPreInspectionSelectProperty>('/lc/log_pre_inspection', service, isDebugMode),
        log_verification: new Request<LogVerification, LogVerificationInsertProperty, LogVerificationDeleteProperty, LogVerificationUpdateProperty, LogVerificationSelectProperty>('/lc/log_pre_inspection', service, isDebugMode),
        log_sdxx_file: new Request<LogSxddFile, LogSxddFileInsertProperty, LogSxddFileDeleteProperty, LogSxddFileUpdateProperty, LogSxddFileSelectProperty>('/lc/log_sdxx_file', service, isDebugMode),
        log_IO: new Request<LogIo, LogIoInsertProperty, LogIoDeleteProperty, LogIoUpdateProperty, LogIoSelectProperty>('/lc/log_io', service, isDebugMode),
        log_goods: new Request<LogGoods, LogGoodsInsertProperty, LogGoodsDeleteProperty, LogGoodsUpdateProperty, LogGoodsSelectProperty>('/lc/log_goods', service, isDebugMode),
        log_rfid_shelf: new Request<LogRfidShelf, LogRfidShelfInsertProperty, LogRfidShelfDeleteProperty, LogRfidShelfUpdateProperty, LogRfidShelfSelectProperty>('/lc/log_rfid_shelf', service, isDebugMode),
        log_stock: new Request<LogStock, LogStockInsertProperty, LogStockDeleteProperty, LogStockUpdateProperty, LogStockSelectProperty>('/lc/log_stock', service, isDebugMode),
        log_meter: new Request<LogMeter, LogMeterInsertProperty, LogMeterDeleteProperty, LogMeterUpdateProperty, LogMeterSelectProperty>('/lc/log_meter', service, isDebugMode),
        log_receive: new Request<LogReceive, LogReceiveInsertProperty, LogReceiveDeleteProperty, LogReceiveUpdateProperty, LogReceiveSelectProperty>('/lc/log_receive', service, isDebugMode),
        log_garbage: new Request<LogGarbage, LogGarbageInsertProperty, LogGarbageDeleteProperty, LogGarbageUpdateProperty, LogGarbageSelectProperty>('/lc/log_garbage', service, isDebugMode),
        log_garbage_details: new Request<LogGarbageDetails, LogGarbageDetailsInsertProperty, LogGarbageDetailsDeleteProperty, LogGarbageDetailsUpdateProperty, LogGarbageDetailsSelectProperty>('/lc/log_garbage_details', service, isDebugMode),
        // function
        getVersion: () => mewRequest('/lc/select/version', {}, 'POST', service, isDebugMode),
        /**
         * 工具借还记录接口
         * @param params
         */
        toolStatusChange: async (params: ToolStatusChangeParamType) => {
            const res = await mewRequest('/lc/log/toolStatus/change', params, 'POST', service, isDebugMode)
            console.log(165, res)
            return res
        },
        /**
         ...
         * @param params
         */
        logFeedbackArrInsert: async (params: any) => {
            const url = '/lc/log_feedback/insert/toolArr'
            return await mewRequest(url, params, 'POST', service, isDebugMode)
        },
        logRentInsertBatch: async (params: LogRentInsertBatchProperty) => {
            const url = '/lc/log_rent/insert/batch'
            return await mewRequest(url, params, 'POST', service, isDebugMode)
        },
        logInsertBatch: async (params: logInsertBatchParamType) => {
            return await mewRequest('/lc/log/insert/batch', params, 'POST', service, isDebugMode)
        },
        logFeedbackGoods: async (params: logSelectFeedbackGoodsParamType) => {
            return await mewRequest('/lc/log_feedback/select/goods', params, 'POST', service, isDebugMode)
        },
        sendEmail: (json: SendEmailProperty) => mewRequest('/lc/email_template/sendEmail', json, 'POST', service, isDebugMode),
        getStepTotalPrice: (json: LogRentStepTotalPriceProperty) => mewRequest('/lc/log_rent/getStepTotalPrice', json, 'POST', service, isDebugMode),
        getTopTenUsageTimes: (json: TopTenUsageTimesProperty) => mewRequest('/lc/log/getTopTenUsageTimes', json, 'POST', service, isDebugMode),
    }
}
